...
## [0.18.0](https://github.com/BluerAngala/obsidian-aiwork/compare/0.17.2...0.18.0) (2026-08-09)


### Features

* **activity:** add shared activity rows ([6d80461](https://github.com/BluerAngala/obsidian-aiwork/commit/6d8046189c0c6812f1ab5016e9074a8fdc830293))
* **activity:** add shared lifecycle statuses ([2582444](https://github.com/BluerAngala/obsidian-aiwork/commit/2582444d24790268bcf65f68b794d4e84bc97052))
* **activity:** localize status presentation ([41dd15f](https://github.com/BluerAngala/obsidian-aiwork/commit/41dd15ffe4db4d77f1c3fe2903bf948b4818fe26))
* add inline message editing and drag-drop file context ([a9842d5](https://github.com/BluerAngala/obsidian-aiwork/commit/a9842d55007ca007783d796b12dc0a30a45577b7))
* add new animated icons and fixed mapping for subagents ([73b2c74](https://github.com/BluerAngala/obsidian-aiwork/commit/73b2c74564e3dac19f379fe40d35bd515d0e47c1))
* add review mode selector and system prompt management ([35de878](https://github.com/BluerAngala/obsidian-aiwork/commit/35de878d787a8f9c14e5eb43d7fe0f18ef71c860))
* add review mode toggle next to attachment button above input ([95967cf](https://github.com/BluerAngala/obsidian-aiwork/commit/95967cf41db433b5fe18df7ce4edd0cc16c80062))
* add smart review mode and enhanced question UX ([9dca1b2](https://github.com/BluerAngala/obsidian-aiwork/commit/9dca1b2c9f9bf91c5e3d481792e399e8822a41fe))
* **agent:** add managed Pivi capabilities ([a69af8c](https://github.com/BluerAngala/obsidian-aiwork/commit/a69af8c2798dc9e9067f35941cdfe5c1ff1213c0))
* **agents:** add active work shelf ([c63134e](https://github.com/BluerAngala/obsidian-aiwork/commit/c63134e2311dc9523757a1fe89c2eaadfff1e9e1))
* **agents:** add run timeline inspector ([a590fa6](https://github.com/BluerAngala/obsidian-aiwork/commit/a590fa6e33f9bb7b6aa67eecde0113ffaaa49d89))
* **agents:** add stable AgentRun projection ([624a2ea](https://github.com/BluerAngala/obsidian-aiwork/commit/624a2eaa6cf9f0d30ca6ea94efc0b15d924f2181))
* **agents:** group related Agent runs ([625cc94](https://github.com/BluerAngala/obsidian-aiwork/commit/625cc94593c9e5ef7c6654f123faac941e233df0))
* **agents:** promote structured conclusions ([4f28758](https://github.com/BluerAngala/obsidian-aiwork/commit/4f287581546fa87dafec2a0bb60e0febbb45759b))
* **ai:** support max thinking level ([1ad2895](https://github.com/BluerAngala/obsidian-aiwork/commit/1ad2895ff42947577aa25cbdccf457e1815e8b41))
* **auth:** upgrade pi to 0.82.0 and add OpenRouter/Kimi OAuth ([94b0697](https://github.com/BluerAngala/obsidian-aiwork/commit/94b0697af645835666da548b05624c0fd98b0ade))
* **chat:** add drag-to-resize handle for input area ([3bf14f6](https://github.com/BluerAngala/obsidian-aiwork/commit/3bf14f68027a09c0de93c19eff5e6df0b2b095e0))
* **chat:** add editable synced tab titles ([46d30e6](https://github.com/BluerAngala/obsidian-aiwork/commit/46d30e67c7b853f07e5f472cef4d5f191044af11)), closes [#36](https://github.com/BluerAngala/obsidian-aiwork/issues/36)
* **chat:** add nested disclosure sticky stack for subagent tool cards ([e72dc90](https://github.com/BluerAngala/obsidian-aiwork/commit/e72dc906624093e219e3d799172b57c9c858172c))
* **chat:** add new-session slash command ([d8fbc4b](https://github.com/BluerAngala/obsidian-aiwork/commit/d8fbc4b4a71d8f9cbe4380ab8c18a7029dfff83d))
* **chat:** add sortable queued turns and tabs ([ed04f7c](https://github.com/BluerAngala/obsidian-aiwork/commit/ed04f7c43cf50735fd4bd156f59e3f8d8a9d3899))
* **chat:** add welcome quote background ([2f5d32d](https://github.com/BluerAngala/obsidian-aiwork/commit/2f5d32d4c9fc2d5b5865991c2714c073282f3311))
* **chat:** constrain Mermaid diagrams in messages ([8248d42](https://github.com/BluerAngala/obsidian-aiwork/commit/8248d423d449ff5635fb073e12bbb233113484d4))
* **chat:** copy conversation through a turn as markdown ([17a4c59](https://github.com/BluerAngala/obsidian-aiwork/commit/17a4c59012f89d665f0fe64310523137298958ef))
* **chat:** expand subagent writer profiles ([eb613fb](https://github.com/BluerAngala/obsidian-aiwork/commit/eb613fb90b1517b99d2a81213a60056470fa456c))
* **chat:** expose session range pages ([15d6b70](https://github.com/BluerAngala/obsidian-aiwork/commit/15d6b70f74acaf4bea23e6517211d959d021776a))
* **chat:** randomly assign unused subagent writer names ([9a59e3b](https://github.com/BluerAngala/obsidian-aiwork/commit/9a59e3b5dbd3e811666b5bfda024ca1adccff1cc))
* **chat:** recover deleted sessions ([c136d4d](https://github.com/BluerAngala/obsidian-aiwork/commit/c136d4d858bef5d2a3cdb86f76b3d971e01e9f7b))
* **chat:** redesign external context handling ([95057a4](https://github.com/BluerAngala/obsidian-aiwork/commit/95057a439052b34bf1d413e20822669ecc8a35e1))
* **chat:** reference and manage durable sessions ([303d688](https://github.com/BluerAngala/obsidian-aiwork/commit/303d688d3758c4f94578356cc919a42378eab24c))
* **chat:** refine agent workflows and presentation ([b629687](https://github.com/BluerAngala/obsidian-aiwork/commit/b6296879c1d5fd2bd8286b15ae3756e863d78461))
* **chat:** sequence projection events ([0a03770](https://github.com/BluerAngala/obsidian-aiwork/commit/0a0377009b328669c7dcbac4a1c544321b0cf376))
* **chat:** support redo for agent turns ([0603544](https://github.com/BluerAngala/obsidian-aiwork/commit/0603544e7ed77ce04a2787b30b83494a14ab7e14))
* **commands:** add customizable Note Toolbar commands ([c32e435](https://github.com/BluerAngala/obsidian-aiwork/commit/c32e43575f74d589e7417ed8785eb3dae688a41b))
* **commands:** add expandable command cards ([a29943d](https://github.com/BluerAngala/obsidian-aiwork/commit/a29943d126f4fbf32bdf568cbd57c2811190f231))
* **commands:** add mention support in prompt editor, remove Note Toolbar button ([988bb3d](https://github.com/BluerAngala/obsidian-aiwork/commit/988bb3d9526d831676d900d21366cad8c292262f))
* **context:** add conservative envelope model ([c905f74](https://github.com/BluerAngala/obsidian-aiwork/commit/c905f74381e52c8dd9cc78fa81a15a4db995c9cc))
* **context:** add context inspector ([4cd0527](https://github.com/BluerAngala/obsidian-aiwork/commit/4cd05271dd5395f47689f946e3ab79365cfbb68c))
* **context:** apply envelope compaction headroom ([e3cffbc](https://github.com/BluerAngala/obsidian-aiwork/commit/e3cffbc7fc725ad5870dcb9411431c09f38ff5dd))
* **credentials:** separate web search API keys from Pi provider credentials ([031aa6a](https://github.com/BluerAngala/obsidian-aiwork/commit/031aa6a79e330d0717a33d041254cdbf9375b828))
* **editor:** add persistent inline edit workflow ([2f1391a](https://github.com/BluerAngala/obsidian-aiwork/commit/2f1391afbbf14d92b0d8db9bfbcbc6e5e10f5cf2))
* **engine:** upgrade Pi and dependencies ([4094813](https://github.com/BluerAngala/obsidian-aiwork/commit/40948131499176e8b83e0ef7fa036694d3d9f6ac))
* enhance chat UI with message history, editing, and layout improvements ([44badf7](https://github.com/BluerAngala/obsidian-aiwork/commit/44badf77a0587dbecfebd6dab07ef71e675c3720))
* **host:** snapshot notes in File Recovery before vault mutations ([fb3dcd6](https://github.com/BluerAngala/obsidian-aiwork/commit/fb3dcd6ac7a790239f5c3d006cf1245bd3f0ed1f))
* **i18n:** localize full UI and match agent reply language ([fdc9af1](https://github.com/BluerAngala/obsidian-aiwork/commit/fdc9af1551399d6ae397103e73079547cdd9d110))
* **memory:** expand checkpoint details ([45cea11](https://github.com/BluerAngala/obsidian-aiwork/commit/45cea116a26f67e23abbd733a305c3365deed69e))
* **memory:** show compaction and history boundaries ([032a9f3](https://github.com/BluerAngala/obsidian-aiwork/commit/032a9f349c70aef60ce549bf09daa1a7ef03af8b))
* **mention:** support aliased vault file mentions ([345f34d](https://github.com/BluerAngala/obsidian-aiwork/commit/345f34d16ca34c7ec2d158d6b68c2a84384b0b63))
* **models:** support additional Pi providers ([761daf0](https://github.com/BluerAngala/obsidian-aiwork/commit/761daf075b9978490dae095a70837acb289c38eb))
* move attachment button above input as a styled button ([35be1b8](https://github.com/BluerAngala/obsidian-aiwork/commit/35be1b8ea4dfd5c594d97d4743665db5d9ed7c8c))
* **network:** add scoped HTTP egress client and remove global fetch patch ([a01973c](https://github.com/BluerAngala/obsidian-aiwork/commit/a01973cebd6c4bfbc8cadc5ff5f81513909e206d))
* **obsidian-ui:** migrate chat surfaces to React with HEAD parity ([e97eb20](https://github.com/BluerAngala/obsidian-aiwork/commit/e97eb202ed76ca12fc8581b84578dc775bfccf51))
* **obsidian-ui:** unify product style system ([c955d5c](https://github.com/BluerAngala/obsidian-aiwork/commit/c955d5c0248a8bdb5d40e9b95ad7f146b80335ff))
* **obsidian:** add vault analysis tools ([67fb752](https://github.com/BluerAngala/obsidian-aiwork/commit/67fb752d90fddb0507791ae1601407a51dbd8b52))
* **perf:** add chat instrumentation seams ([bf4d50b](https://github.com/BluerAngala/obsidian-aiwork/commit/bf4d50b918072cd82e0a556c1834941aec621448))
* **perf:** add deterministic Markdown stream driver ([d948a74](https://github.com/BluerAngala/obsidian-aiwork/commit/d948a74ab704a69e045a91f8a3af7245103bc188))
* **perf:** add development chat trace recorder ([b356927](https://github.com/BluerAngala/obsidian-aiwork/commit/b35692714303a4518ce363d544cd6961888b2a03))
* **perf:** isolate tab switching workload ([0674879](https://github.com/BluerAngala/obsidian-aiwork/commit/0674879818164004e0e0c54aed287840fbb134f7))
* prepare next Pivi release ([d029e64](https://github.com/BluerAngala/obsidian-aiwork/commit/d029e6461fada75509d8e064e150c3703fe39e03))
* **prompt:** prefer note wikilinks over restating vault content ([4e3ba60](https://github.com/BluerAngala/obsidian-aiwork/commit/4e3ba600ae1de3bfc3f811bef9e5e0e46e055bdd))
* **providers:** add custom/local provider support ([7ec5fa8](https://github.com/BluerAngala/obsidian-aiwork/commit/7ec5fa82fa031c00da0f9b49ac9075c5873e7776))
* refactor TabBar rendering and animate exit callbacks ([b8640ce](https://github.com/BluerAngala/obsidian-aiwork/commit/b8640cee72f14f8a9e43ddad0ab8a8d8c9e83c15))
* **release:** add BRAT beta pre-release workflow ([5a7df90](https://github.com/BluerAngala/obsidian-aiwork/commit/5a7df900585aac07d1f9840d401d73b950606c66))
* **security:** add turn-scoped high-risk confirms and bounded Skills/MCP extensions ([8b28a09](https://github.com/BluerAngala/obsidian-aiwork/commit/8b28a0985183ec468e0afafd5b15526772a47d26))
* **security:** bound process execution and vault mutation paths ([0fe7a27](https://github.com/BluerAngala/obsidian-aiwork/commit/0fe7a27c376b4f4d60e15ad3c9c2af3bf5b5c934))
* **security:** complete release assurance gates and Pi pin hardening ([1f641e4](https://github.com/BluerAngala/obsidian-aiwork/commit/1f641e45b19043af6f897bc333fdcfee12ea1f5a))
* **security:** device-local env sources and transactional MCP secrets ([d274b8e](https://github.com/BluerAngala/obsidian-aiwork/commit/d274b8e0d02db956bdc6d12ff6244c35ba74ce09))
* **session:** add append-safe JSONL index ([58da99f](https://github.com/BluerAngala/obsidian-aiwork/commit/58da99f27fe47bf720a8397658f1f348f3511855))
* **session:** add continuation schemas ([81e04c7](https://github.com/BluerAngala/obsidian-aiwork/commit/81e04c7ada855ebae76f15863f1dce5a7f7306c2))
* **session:** add indexed message range reads ([78897cc](https://github.com/BluerAngala/obsidian-aiwork/commit/78897cca1bd7e70e9143a12902928051a7100080))
* **session:** hydrate chat history by indexed pages ([0fd67bd](https://github.com/BluerAngala/obsidian-aiwork/commit/0fd67bdd48fd131b3dae3deb1ea173bfb0c4384b))
* **session:** persist compaction checkpoints ([d991e8c](https://github.com/BluerAngala/obsidian-aiwork/commit/d991e8c58dddcb01294806218de1d182f3ae3de6))
* **session:** recover cloud JSONL replacement via device-local journal ([2ce349f](https://github.com/BluerAngala/obsidian-aiwork/commit/2ce349fb9dc0729caaf8c2f04b5bf7cbb6bad22c))
* **settings:** add Anthropic Pro/Max browser OAuth ([0146195](https://github.com/BluerAngala/obsidian-aiwork/commit/0146195849ad0345019de5fcd5d1ecbcc7139cf8))
* **settings:** add drag reorder for custom commands and toolbar shortcuts ([07c0fd2](https://github.com/BluerAngala/obsidian-aiwork/commit/07c0fd25a55772b0606baf1a93a06a60aa8a76b0))
* **settings:** add sortable provider fallback ([443bdd9](https://github.com/BluerAngala/obsidian-aiwork/commit/443bdd96f87889b38cf85bb6d042611adf6faab0))
* **settings:** add Style Settings and Note Toolbar integrations ([29b4402](https://github.com/BluerAngala/obsidian-aiwork/commit/29b440253e3341e7029caf66dba1f72a3cc337ca))
* **settings:** add xAI provider with OAuth ([ff4e20c](https://github.com/BluerAngala/obsidian-aiwork/commit/ff4e20c607026e63bb3122d073291c234978eb33))
* **settings:** browse folders for external-read allowlist ([b107c03](https://github.com/BluerAngala/obsidian-aiwork/commit/b107c03ee036ee45f05d037245d2fa2cdb7b0074))
* **settings:** improve command icon selection ([6115154](https://github.com/BluerAngala/obsidian-aiwork/commit/6115154dc8adc126da3d89172ecc23ee98ff155e))
* **settings:** redesign layout system and unify tools page ([ef24060](https://github.com/BluerAngala/obsidian-aiwork/commit/ef24060cb7d36f9030b213e28ebf5ffe90d9f399))
* **settings:** refine command and collection workflows ([a79a66b](https://github.com/BluerAngala/obsidian-aiwork/commit/a79a66bc530f5a29c96bb8a8b02e722c9692e871))
* **settings:** refine configuration and MCP tool inventory ([434ef89](https://github.com/BluerAngala/obsidian-aiwork/commit/434ef899f9e1029574cff5eb5c6fa4f63b4d4b72))
* **settings:** split subscription provider identities ([db59740](https://github.com/BluerAngala/obsidian-aiwork/commit/db597400b55c4c28d17d2aef92f8dfa7b4434ddc))
* **settings:** streamline command and MCP workflows ([9436ef7](https://github.com/BluerAngala/obsidian-aiwork/commit/9436ef758ceb21cddccb2bf3e6663c7c2fd64d1e))
* **settings:** unify enable and remove controls across cards ([c563896](https://github.com/BluerAngala/obsidian-aiwork/commit/c563896d72dd8493a2a45e2c0cf6d6b457b4e727))
* **skills:** restore pinned skills CLI and refresh minor deps ([450dd18](https://github.com/BluerAngala/obsidian-aiwork/commit/450dd18f862e9ce98be9f91cddc01c52fdfc78cc))
* **skills:** support featured bundle updates ([64446ed](https://github.com/BluerAngala/obsidian-aiwork/commit/64446edb8bfa32076717a6fea2a0f966fa3e049e))
* **styles:** support Style Settings typography controls ([5c1ae5b](https://github.com/BluerAngala/obsidian-aiwork/commit/5c1ae5be0de4be7131e96bdf6338cd42ffbc1038))
* **subagents:** consume structured reports ([2c48a0d](https://github.com/BluerAngala/obsidian-aiwork/commit/2c48a0d0e2b3e898cebbd8ba1dd60bddbced8520))
* **toolbar:** add configurable editor commands ([6971eeb](https://github.com/BluerAngala/obsidian-aiwork/commit/6971eebefabdf71458b568114813ce98b7ac57aa))
* **toolbar:** add editor selection toolbar and inline edit ([b80d3e4](https://github.com/BluerAngala/obsidian-aiwork/commit/b80d3e4ac33f3719d15073649d9436dcee52364a))
* **toolbar:** add inline edit selection command ([20d727a](https://github.com/BluerAngala/obsidian-aiwork/commit/20d727a084d20fc0a3744ab667a9f107b09d515a))
* **tools:** add allowlisted Bash tool ([e26e8a6](https://github.com/BluerAngala/obsidian-aiwork/commit/e26e8a6aa7859174bb45c954c2884251c7d637a4))
* **tools:** add sidebar capability approvals for bash and external access ([8145489](https://github.com/BluerAngala/obsidian-aiwork/commit/814548986b3f513180a4e41e463930f726b68861))
* **tools:** allowlist external filesystem access ([4496c62](https://github.com/BluerAngala/obsidian-aiwork/commit/4496c623328b2574a13c631fd96715176bb2fffb))
* **ui:** harden accessibility, overlays, and settings confirmations ([0881251](https://github.com/BluerAngala/obsidian-aiwork/commit/0881251d3c556be2e30bcc058709c1d2e063d551))
* **ui:** refine toolbar commands and archived tabs ([adc9542](https://github.com/BluerAngala/obsidian-aiwork/commit/adc9542004a27402b593bb259d7457bcfc505b9f))
* **ui:** refine transcript content rhythm ([1f5c4f9](https://github.com/BluerAngala/obsidian-aiwork/commit/1f5c4f995dd069e9ce6a2cf2e21292564e28b7e3))
* **web:** remove WebFetch mode and always try extractors ([a501a8b](https://github.com/BluerAngala/obsidian-aiwork/commit/a501a8b1ea58edab22785a976e7e2f41ba3619dd))
* **welcome:** independent card cycling for quote background ([38abb93](https://github.com/BluerAngala/obsidian-aiwork/commit/38abb93c77c9f72df1afa9c594da35e041ac9196))


### Bug Fixes

* **activity:** constrain status motion ([2971f1f](https://github.com/BluerAngala/obsidian-aiwork/commit/2971f1f3f44b3393cbad476a7955c090d5eed433))
* **app:** replace deprecated getView/getAllViews/setWarning/detach, and clean unused variables ([f4e103b](https://github.com/BluerAngala/obsidian-aiwork/commit/f4e103baa37f3f7c1eaf6c8985088c620bb35939))
* **audit:** satisfy Obsidian community review ([24149d3](https://github.com/BluerAngala/obsidian-aiwork/commit/24149d3623a499d8636cfbd2769c7d67decdbfa0))
* **auth:** keep Obsidian secret IDs within the 64-character keychain limit ([8541672](https://github.com/BluerAngala/obsidian-aiwork/commit/85416729dfa7ee802288121ca214fe2dba721237))
* **build:** bound node import postprocessing ([530bf10](https://github.com/BluerAngala/obsidian-aiwork/commit/530bf104aa5af44abde892086d55bcc9d12f3715))
* **build:** restore copy-to-obsidian deploy blocked by audit false positive ([dfcd035](https://github.com/BluerAngala/obsidian-aiwork/commit/dfcd0354f3cc85641d4a60b3e9fc3b820a2bde41))
* **chat:** accept complete checkpoint JSON ([3da3172](https://github.com/BluerAngala/obsidian-aiwork/commit/3da3172197af3f9dab8faa65cfe4f1e6a752c497))
* **chat:** align context indicator with compaction ([2ff4fbe](https://github.com/BluerAngala/obsidian-aiwork/commit/2ff4fbe9416aedf905ff6473b19e62e0368e7100))
* **chat:** align context meter arc with tooltip percentage ([c31d7cc](https://github.com/BluerAngala/obsidian-aiwork/commit/c31d7cc2ea5852ee59e0f20586d20a8dab6a1b0b))
* **chat:** align selector selected typography ([bbe597a](https://github.com/BluerAngala/obsidian-aiwork/commit/bbe597af7717f2b499004a5ba95876e2ba844905))
* **chat:** apply composer model switch to the running agent and block over-limit sends ([e3fd37c](https://github.com/BluerAngala/obsidian-aiwork/commit/e3fd37cce594fd8703d57c88dec1ca26a7ec80e1))
* **chat:** bound tool step groups to content segments ([aafaaaa](https://github.com/BluerAngala/obsidian-aiwork/commit/aafaaaa1754445554d6ddb1c7ed0c50720852fcc))
* **chat:** cap read defaults by compaction headroom ([a56c727](https://github.com/BluerAngala/obsidian-aiwork/commit/a56c7275d4d87bb8e537770494c304949fc01875))
* **chat:** cap tab switcher at ten visible rows ([8b896b2](https://github.com/BluerAngala/obsidian-aiwork/commit/8b896b2cff9bf64a15c89f00150dec4c6448709d))
* **chat:** clarify compaction checkpoint failures ([695352f](https://github.com/BluerAngala/obsidian-aiwork/commit/695352f3dd93cb25e5f4240dfe14c8ebca8a99eb))
* **chat:** clean up tool classification, segment boundaries, tab archive, and inline code path filtering ([8aefee4](https://github.com/BluerAngala/obsidian-aiwork/commit/8aefee422e7b6dbc148e26a714d2c0b64895de7d))
* **chat:** clear retry indicator when streaming resumes ([86cb0a6](https://github.com/BluerAngala/obsidian-aiwork/commit/86cb0a677e9e93b042bf1c263bbfe87bac350212))
* **chat:** clear thinking indicator on agent unavailable ([944f335](https://github.com/BluerAngala/obsidian-aiwork/commit/944f3353237e958001c601a8f5c469d828466fae))
* **chat:** compact before tool loop continuations ([f5715c9](https://github.com/BluerAngala/obsidian-aiwork/commit/f5715c90d85212ead8351c54d39240076d141d11))
* **chat:** defer virtual row resize measurements ([e6c535c](https://github.com/BluerAngala/obsidian-aiwork/commit/e6c535cdcc428c660955daeeec829c6a0545b833))
* **chat:** delete open tabs from the switcher ([5914ce3](https://github.com/BluerAngala/obsidian-aiwork/commit/5914ce3f8b1b0dbe3f78d1f992aaddbcf577e8c0))
* **chat:** drop disclosure shrink chain and double subagent height ([514a8e3](https://github.com/BluerAngala/obsidian-aiwork/commit/514a8e31501885924c0ebe458a9bd6e97e37d45c))
* **chat:** harden context recovery and live model switching ([edc4960](https://github.com/BluerAngala/obsidian-aiwork/commit/edc4960bde6e8d700b29ef23012b252e85eb3185))
* **chat:** harden projection event boundaries ([18e8378](https://github.com/BluerAngala/obsidian-aiwork/commit/18e83782b018ff315e5035d399ff835ce8281138))
* **chat:** harden tools, sessions, and UI lifecycle ([5e47cf9](https://github.com/BluerAngala/obsidian-aiwork/commit/5e47cf9edf06b4e96dcea2089c9662131b790580))
* **chat:** harden vault context compaction ([4bb4915](https://github.com/BluerAngala/obsidian-aiwork/commit/4bb4915c39762820d822f0adcf93299cc2fc1917))
* **chat:** hide leaked external_contexts XML after reload ([7964740](https://github.com/BluerAngala/obsidian-aiwork/commit/79647406b597e067910ce77da28f6b8e24714fcd))
* **chat:** improve tab switcher fallback and close animation ([4acafb3](https://github.com/BluerAngala/obsidian-aiwork/commit/4acafb30a402a4d634288a80af57c24e54657a83))
* **chat:** keep long tab title cursor visible ([dc6169f](https://github.com/BluerAngala/obsidian-aiwork/commit/dc6169ffd5433d47d095e05a14b3d13b8ab4dcd5))
* **chat:** keep streaming output in view ([65a78b6](https://github.com/BluerAngala/obsidian-aiwork/commit/65a78b68a560721fc513955e77264ed5eb8b72ed))
* **chat:** keep tab switcher stable during tab actions ([5748341](https://github.com/BluerAngala/obsidian-aiwork/commit/574834196b8b5b68dd42297fbc0678de6dd0575e))
* **chat:** keep turn capabilities current ([3618915](https://github.com/BluerAngala/obsidian-aiwork/commit/3618915a08a721a36e3e4f728362ab1ea4bb4312))
* **chat:** let read defaults cross compaction threshold ([de3c631](https://github.com/BluerAngala/obsidian-aiwork/commit/de3c631adaaee8cf618b562afcf75d6aa4e69b9b))
* **chat:** mark in-flight subagents Cancelled on interrupt ([d0a7f1f](https://github.com/BluerAngala/obsidian-aiwork/commit/d0a7f1f5c9a6cacb5bc43e642e4db43e3ca36c24))
* **chat:** merge Write and Obsidian edit tool calls into contiguous step groups ([1889437](https://github.com/BluerAngala/obsidian-aiwork/commit/18894371945c4aca9b032b50c8473a2bb1e7eab3))
* **chat:** parallelize and streamline subagent updates ([d8d76d9](https://github.com/BluerAngala/obsidian-aiwork/commit/d8d76d99b686bb0a17b150dd456dabb089a27e9f))
* **chat:** pass images through steer and report queue reorder success ([13c9506](https://github.com/BluerAngala/obsidian-aiwork/commit/13c95068cbcf950bb6fc544a6e6a0474d6f822f4))
* **chat:** polish subagent indicators and context badges ([35ed9ab](https://github.com/BluerAngala/obsidian-aiwork/commit/35ed9abad67599447862cb14414a441773789d1a))
* **chat:** polish tool activity and markdown rendering ([aaadb44](https://github.com/BluerAngala/obsidian-aiwork/commit/aaadb442bd1240b845ea2d5ddb260269bd2202c7))
* **chat:** preserve queue order while dragging ([cb9488e](https://github.com/BluerAngala/obsidian-aiwork/commit/cb9488e38d71f7d14a7bcc25603b56748dcb58a0))
* **chat:** queue deleted archived session files ([a64352b](https://github.com/BluerAngala/obsidian-aiwork/commit/a64352bd4da2d49cd04bb5b61b64711a65801eab))
* **chat:** refresh context meter immediately after compaction ([225b0bb](https://github.com/BluerAngala/obsidian-aiwork/commit/225b0bb707ea75eef3a6a1668ce9f5cd6bba6d99))
* **chat:** render inline code vault paths as wikilinks and enforce alias format ([6b5df53](https://github.com/BluerAngala/obsidian-aiwork/commit/6b5df532a3fd8ed44f060ed29ed60d4a81face87))
* **chat:** replace innerHTML with DOMParser for subagent animated icons ([989cd8d](https://github.com/BluerAngala/obsidian-aiwork/commit/989cd8d4094eaecef252bf63cbd2f54c53ae87a0))
* **chat:** report complete context usage ([54029b4](https://github.com/BluerAngala/obsidian-aiwork/commit/54029b4b870d957e7ab375e267b79b595ccbe6bb))
* **chat:** restore session and subagent presentation ([fbfad95](https://github.com/BluerAngala/obsidian-aiwork/commit/fbfad9515295a2fb4f2494cd32b4a2aedb797c7d))
* **chat:** restore subagent cards from Pi history ([215de54](https://github.com/BluerAngala/obsidian-aiwork/commit/215de540e3aca370f4542dc49b90d5cc57f651f7))
* **chat:** retry TLS handshake disconnects and ECONNRESET ([747e2dc](https://github.com/BluerAngala/obsidian-aiwork/commit/747e2dc02e394ee034de979929de3912e3bc592f))
* **chat:** retry transient provider failures ([24c6cfc](https://github.com/BluerAngala/obsidian-aiwork/commit/24c6cfc076dd5944e4243546042d6337ada54515))
* **chat:** run manual compaction instructions after lock contention ([b6d1d1f](https://github.com/BluerAngala/obsidian-aiwork/commit/b6d1d1fa8021c127778f77c589980a46dcb281b6))
* **chat:** self-heal stale session index during append refresh ([b972aa2](https://github.com/BluerAngala/obsidian-aiwork/commit/b972aa2717d15da826367f23c8fb0434af9e8c77))
* **chat:** show MCP server tool names ([74209a8](https://github.com/BluerAngala/obsidian-aiwork/commit/74209a8a52bf4749bb6607071b9a1c82ee0d9b2e))
* **chat:** skip frontmatter code enhancement ([038a737](https://github.com/BluerAngala/obsidian-aiwork/commit/038a73785a29e17a1a7cc44f3f17d64b108ef1ea))
* **chat:** smooth tab switcher transitions ([fade49c](https://github.com/BluerAngala/obsidian-aiwork/commit/fade49c6c4f54b994ca8f30a9899263c87ae71d4))
* **chat:** stabilize live thinking indicator during streaming ([448984f](https://github.com/BluerAngala/obsidian-aiwork/commit/448984f2ebe414e24ee671185e38692fdf686061))
* **chat:** stabilize subagents, tool previews, and note links ([0b30cd7](https://github.com/BluerAngala/obsidian-aiwork/commit/0b30cd712d277987f1f5fc01810c090dbfe6d0dc))
* **chat:** stabilize tab switcher updates ([c70f53c](https://github.com/BluerAngala/obsidian-aiwork/commit/c70f53c6b194b2965f324484c41cb1c31b2f3653))
* **chat:** stop treating https URLs as device paths in compaction ([d91220b](https://github.com/BluerAngala/obsidian-aiwork/commit/d91220bb12834148489499364d76a70bb71cbc31))
* **chat:** support multi-word writer names with suffix in subagent icon resolution ([2339b9b](https://github.com/BluerAngala/obsidian-aiwork/commit/2339b9ba6ad4921f480b7c721925928c8dda514c))
* **chat:** unify subagent markdown rendering with main chat ([834faf4](https://github.com/BluerAngala/obsidian-aiwork/commit/834faf4a6fe3a8f8edf737f7fb8b106a82c4e534))
* **chat:** update subagent status animations ([b366f84](https://github.com/BluerAngala/obsidian-aiwork/commit/b366f84b27cc4276323ee5e18187123880576f1f))
* **chat:** upgrade incomplete subagent overlays from Pi results ([7f5dd6a](https://github.com/BluerAngala/obsidian-aiwork/commit/7f5dd6a8680e1f7e5bebe9db9e7241a405f5f19c))
* **composer:** increase default input height ([901c1d0](https://github.com/BluerAngala/obsidian-aiwork/commit/901c1d084cdee6b1025ad33cbef9c076d39deb0b))
* **composer:** remove duplicate focus ring ([fbf26fb](https://github.com/BluerAngala/obsidian-aiwork/commit/fbf26fbc9127aef15652865a9c620c2eae6de058))
* **context:** honor reduced motion ([716c0cc](https://github.com/BluerAngala/obsidian-aiwork/commit/716c0cc0383cf31772036901ba26e67a5edbffe3))
* **context:** preserve context authority semantics ([a45472e](https://github.com/BluerAngala/obsidian-aiwork/commit/a45472e84517c0b606f1bb82bd8e465d0697b5d2))
* **core:** resolve unsafe typescript-eslint member access and typecast warnings ([f3d652c](https://github.com/BluerAngala/obsidian-aiwork/commit/f3d652c14ee59b1a6b380601e7fe0422d3d54ce2))
* **editor:** align inline edit markdown rhythm ([423df37](https://github.com/BluerAngala/obsidian-aiwork/commit/423df37017a21c022b7428092d5a432f8ba36690))
* **editor:** align inline edit review with sidebar output ([6e61de5](https://github.com/BluerAngala/obsidian-aiwork/commit/6e61de5a9b4a8ab60ed38a5fe7bb1391c9badf83))
* **editor:** align inline edit streaming with sidebar output ([6ea5367](https://github.com/BluerAngala/obsidian-aiwork/commit/6ea5367d28089f377f379e73b511bb6512c28970))
* **editor:** close Ask AI transport tabs after each turn ([6387167](https://github.com/BluerAngala/obsidian-aiwork/commit/6387167a0d01d668567548a7aa2cc1c1e345b3bf))
* **editor:** close inline edit on escape ([12cb3b3](https://github.com/BluerAngala/obsidian-aiwork/commit/12cb3b304f65776aad86865785944dd45c062769))
* **editor:** honor output-only inline edit requests ([9c9d7f0](https://github.com/BluerAngala/obsidian-aiwork/commit/9c9d7f014d61d5ecfddfe2a74710bc3d600d9699))
* **editor:** keep inline edit openable across file switches ([bc0ef99](https://github.com/BluerAngala/obsidian-aiwork/commit/bc0ef99e6a3abd8e74727df9c1056dac94b3e9f9))
* **editor:** keep inline edit output in reply mode ([7653a1a](https://github.com/BluerAngala/obsidian-aiwork/commit/7653a1a2525209855fa67387991e1c325c7a82e9))
* **editor:** polish inline edit review interactions ([22776ee](https://github.com/BluerAngala/obsidian-aiwork/commit/22776ee1d11da617c23efef6e47121aa734a79a1))
* **editor:** reuse chat markdown rendering for inline edit ([b3ee714](https://github.com/BluerAngala/obsidian-aiwork/commit/b3ee714f0b2c766fc12a3326df90ec8697398813))
* **engine:** pin openai-codex transport to SSE in the Obsidian renderer ([905c532](https://github.com/BluerAngala/obsidian-aiwork/commit/905c532ca9d2cc3788bee6601200de8e5df38b22))
* **engine:** restore provider requests with Pi 0.83 ([c9f3151](https://github.com/BluerAngala/obsidian-aiwork/commit/c9f31512fc2d308751647df863f5743e3a4bac01))
* force AskUserQuestion tool for deletions instead of plain-text questions ([fd3a77a](https://github.com/BluerAngala/obsidian-aiwork/commit/fd3a77a319c5eb653b77acfe6b561c110d78135b))
* harden turn recovery and resource accounting ([389470c](https://github.com/BluerAngala/obsidian-aiwork/commit/389470cb489e79659f57170a256ae13c79bd8759))
* **host:** avoid globalThis and bind auth context methods safely ([9983b99](https://github.com/BluerAngala/obsidian-aiwork/commit/9983b99fd4a50f13c8f56cdfa7168ed3be73323b))
* improve composer toolbar, message actions, and folder links ([d3a857c](https://github.com/BluerAngala/obsidian-aiwork/commit/d3a857c74e713043137aa083963ef0269617fd1b))
* make deletion confirmation an explicit exception to default-to-action rule ([b7e0dcc](https://github.com/BluerAngala/obsidian-aiwork/commit/b7e0dcc94a49a47fe85b94a79abd00db0320d0af))
* **management:** harden configuration transactions ([924fa85](https://github.com/BluerAngala/obsidian-aiwork/commit/924fa85af89ce10b9b63b083539e2526379ea035))
* **mcp:** declare resolve and reject as function properties to allow safe destructuring ([dd7bb34](https://github.com/BluerAngala/obsidian-aiwork/commit/dd7bb3407cea520fe5e8dfde6333ddd36665a9e0))
* **models:** follow upstream xAI catalog for Grok Build ([7195066](https://github.com/BluerAngala/obsidian-aiwork/commit/719506672cd3f79de9c91163d7cec676f79cb0db))
* **network:** disarm connect socket timeout after response headers arrive ([4f35590](https://github.com/BluerAngala/obsidian-aiwork/commit/4f3559062835ec034ac680defcdcbe90ae971af9))
* **network:** separate connect and first-byte deadlines ([70431f9](https://github.com/BluerAngala/obsidian-aiwork/commit/70431f9fe8503b97dcdff7853ac1aaab8526b8d0))
* **obsidian:** address community review feedback ([1cc9d31](https://github.com/BluerAngala/obsidian-aiwork/commit/1cc9d319652efa16804137ff82718e6dc2eb1a14))
* **obsidian:** satisfy community review CSS, audit, and dependency findings ([aff6bd4](https://github.com/BluerAngala/obsidian-aiwork/commit/aff6bd43c6893c0a06c6ecd6bc0d74acb0f0b9ac))
* **perf:** drive indexed paging through scroll ([8326945](https://github.com/BluerAngala/obsidian-aiwork/commit/8326945afa183722019b23da505b764e1f243ecf))
* **perf:** isolate Agent-run trace boundary ([8b56684](https://github.com/BluerAngala/obsidian-aiwork/commit/8b56684f4a136b61ef6067304ed9ac3877c0b0c2))
* **perf:** isolate indexed paging fixture writes ([0356645](https://github.com/BluerAngala/obsidian-aiwork/commit/0356645c3af71d00c33cf52bf6da2ca8f7a84574))
* **perf:** isolate markdown workload tab ([f84c42d](https://github.com/BluerAngala/obsidian-aiwork/commit/f84c42d927c5d1a6f219bd08abc2b6a2567c43b2))
* **prompt:** add math delimiter rules to Obsidian Markdown Hygiene section ([f7436cd](https://github.com/BluerAngala/obsidian-aiwork/commit/f7436cdc17fb85a249224c69b6e8958a9b068374))
* **prompt:** avoid accidental Obsidian markdown syntax ([4531ab8](https://github.com/BluerAngala/obsidian-aiwork/commit/4531ab884644837270c36121abaa7948e7cd0a70))
* **prompt:** list run_in_background as required spawn_agent parameter ([d2cc413](https://github.com/BluerAngala/obsidian-aiwork/commit/d2cc41368ee90cc9be10e9147fe07debb9ac282f))
* **providers:** harden custom model metadata refresh ([ab396e4](https://github.com/BluerAngala/obsidian-aiwork/commit/ab396e4813cd9635d73595fc24065e09add32aed))
* **providers:** refresh local model context metadata ([e55f933](https://github.com/BluerAngala/obsidian-aiwork/commit/e55f933a9192c1f446153ef05fab4e4eb652c961))
* **providers:** restore Zed llama.cpp logo ([6a9181e](https://github.com/BluerAngala/obsidian-aiwork/commit/6a9181e53c09683fabd7d47f01f3404ca0376c6f))
* reconcile children inside TabBar and avoid redundant parent appends ([6e5eb0d](https://github.com/BluerAngala/obsidian-aiwork/commit/6e5eb0d442d41eb4a60ef1b6ff4ff9c1e7c0b605))
* reconcile tab items in-place to prevent background switcher flicker ([84f9be8](https://github.com/BluerAngala/obsidian-aiwork/commit/84f9be8e318df66504ca95abd411fca16a3c7a8d))
* **release:** avoid incompatible attestations ([fddd516](https://github.com/BluerAngala/obsidian-aiwork/commit/fddd5163f669d68d9d73070b2bab69c4d4711761))
* **release:** bind attestations to release tags ([e9e60e6](https://github.com/BluerAngala/obsidian-aiwork/commit/e9e60e6a777404048c2d18db54cf2ee0f8e63233))
* **release:** generate categorized beta changelogs ([f353f25](https://github.com/BluerAngala/obsidian-aiwork/commit/f353f25645ac0c7b60c2d323f1256a9b0ee3f16a))
* **release:** harden asset attestations ([dd98c39](https://github.com/BluerAngala/obsidian-aiwork/commit/dd98c39557a4992b830d8a257d84e9166ef2e6b3))
* **release:** publish from tag pushes ([1373aab](https://github.com/BluerAngala/obsidian-aiwork/commit/1373aaba807adf75294fd34272abdedbba6bbe47))
* replace any types with number types to resolve typescript warnings ([ec66430](https://github.com/BluerAngala/obsidian-aiwork/commit/ec6643016a3012d7addd2acef5167461d7f77198))
* resolve tab exit state race conditions, adjust css transitions, and add unit tests ([75371dd](https://github.com/BluerAngala/obsidian-aiwork/commit/75371dd51ccd8a193e48a2c3562b375c23548f55))
* **review:** drop plugin self-file literals from shipped bundle ([1570cc6](https://github.com/BluerAngala/obsidian-aiwork/commit/1570cc6d0550a7e6e454b2bf011128c64115c114))
* **runtime:** harden provider and session lifecycle ([c08d703](https://github.com/BluerAngala/obsidian-aiwork/commit/c08d70333f1c1ff683eee424d69c604ea0d3b9f0))
* **security:** address release-blocking review findings ([d315bfc](https://github.com/BluerAngala/obsidian-aiwork/commit/d315bfc4a87676a2c5360d05b737ec3ad5e6aca5))
* **security:** block private web targets and harden local provider grants ([7935502](https://github.com/BluerAngala/obsidian-aiwork/commit/7935502751bca7067f2591bd29df2e18977f7471))
* **security:** bypass vault confirms with File Recovery ([764afe9](https://github.com/BluerAngala/obsidian-aiwork/commit/764afe9c593297fd134d2922869d97d63bfadad9))
* **security:** close release review gaps ([6cca618](https://github.com/BluerAngala/obsidian-aiwork/commit/6cca6180bd35606cf9922e5917b30e5a8da79f88))
* **security:** harden MCP OAuth, stdio env, and process results ([82300f0](https://github.com/BluerAngala/obsidian-aiwork/commit/82300f0483456b4e57059bebac6c688be9a51bb5))
* **session:** persist generated titles before publishing ([069ec1b](https://github.com/BluerAngala/obsidian-aiwork/commit/069ec1b6f6575f6913e7c94ab8c5b3ffba705bfe))
* **session:** preserve partial hydration semantics ([2b79aba](https://github.com/BluerAngala/obsidian-aiwork/commit/2b79aba623fc53bebcf5fc2475a9edf930c25105))
* **session:** preserve tool order from partial overlays ([076be9b](https://github.com/BluerAngala/obsidian-aiwork/commit/076be9bad74ab5a660fda476103c6683af9b8e6f))
* **session:** restore synced titles across devices ([26d93ad](https://github.com/BluerAngala/obsidian-aiwork/commit/26d93ad0fb25149d5defd0b33fad59ebb97ca07f))
* **session:** run external context migration once ([b1732bb](https://github.com/BluerAngala/obsidian-aiwork/commit/b1732bbb3f0baf6a3cf64e663cffb6f11dcad59f))
* **settings:** align collection add controls ([9c5ead1](https://github.com/BluerAngala/obsidian-aiwork/commit/9c5ead1f3567841eaa0438299fb313955184d742))
* **settings:** align provider picker styling ([1fd98bb](https://github.com/BluerAngala/obsidian-aiwork/commit/1fd98bb05d89a53ca015dc333a623a44e236aa37))
* **settings:** align Style Settings action ([842c2be](https://github.com/BluerAngala/obsidian-aiwork/commit/842c2be42cad013118437e4fc9d21cd7215163f8))
* **settings:** clarify permanent session deletion ([248bf33](https://github.com/BluerAngala/obsidian-aiwork/commit/248bf333d9bcb579be31fe24119b6dfc6a8c3fcc))
* **settings:** group built-in tools ([09c1a48](https://github.com/BluerAngala/obsidian-aiwork/commit/09c1a48aa5f96705305b6c105bc11654bc2ca525))
* **settings:** keep provider registry device-local ([b7c86c7](https://github.com/BluerAngala/obsidian-aiwork/commit/b7c86c75ee6620073001222fdb89c362a81e97dc))
* **settings:** migrate legacy external context pins ([07e510c](https://github.com/BluerAngala/obsidian-aiwork/commit/07e510ca023287af3ad2376da6edce262f49572a))
* **settings:** oauth precheck membership-stable deps and auth errors ([f4c9122](https://github.com/BluerAngala/obsidian-aiwork/commit/f4c9122916c70caa43cdd18f79e36a2ff9a247a4))
* **settings:** refresh locale and normalize selectors ([87382bb](https://github.com/BluerAngala/obsidian-aiwork/commit/87382bbcd55610f30705ade5c9e9e6c8950ac1d2))
* **settings:** refresh OAuth credentials before provider readiness badges ([da457c8](https://github.com/BluerAngala/obsidian-aiwork/commit/da457c845adeda302113848d94e65ad01fc7e8b6))
* **settings:** route feedback through Obsidian notices ([4322677](https://github.com/BluerAngala/obsidian-aiwork/commit/43226778f5e2dd918435e4dd00206ea34ea2a12f))
* **settings:** show Pivi Sessions tool ([d3f22c7](https://github.com/BluerAngala/obsidian-aiwork/commit/d3f22c7e3ddef4323b37f0b3fcb1caff4f666b71))
* **settings:** simplify tool toggles and disable skills ([aa94e75](https://github.com/BluerAngala/obsidian-aiwork/commit/aa94e75100ded075a4c04494bcc2d1b5735e19d4))
* **settings:** standardize context limit labels ([4bff7e0](https://github.com/BluerAngala/obsidian-aiwork/commit/4bff7e0d9e81e9f9c213d1c4abf0da7b4f5bad7c))
* **settings:** widen environment editor ([90bc51b](https://github.com/BluerAngala/obsidian-aiwork/commit/90bc51bb78db9039c0bfd131184a6b314297b22a))
* **skills:** restore bundled CLI updates ([6671b4d](https://github.com/BluerAngala/obsidian-aiwork/commit/6671b4d0dbe10c25b8a40dc060aa68ba92df107a))
* **skills:** support Windows publication transactions ([5cec2fb](https://github.com/BluerAngala/obsidian-aiwork/commit/5cec2fb29ff94fface2d0ac2dfc95e76a5f75ceb))
* **skills:** validate live tree before staging ([b3d842f](https://github.com/BluerAngala/obsidian-aiwork/commit/b3d842fa198530ec329e6800fbd2ded13824304c))
* **subagent:** prefer Pi terminal result and clear orphan running state ([86a7929](https://github.com/BluerAngala/obsidian-aiwork/commit/86a79292eadf2fe3f03b5fb7ac0a81dbd2fcbd55))
* switch active tab immediately and animate title text transition ([4acebbe](https://github.com/BluerAngala/obsidian-aiwork/commit/4acebbed9a7ce0ede151737093d2945f1a50d54e))
* switch active tab immediately using isActive, cancel title timeout race conditions, and add title transition ([71cacc5](https://github.com/BluerAngala/obsidian-aiwork/commit/71cacc5fd7420a15db639a7cf037909174785552))
* **tests:** allow external read mocks to bypass capability approval gate ([85fc5ae](https://github.com/BluerAngala/obsidian-aiwork/commit/85fc5ae46c84db8b528f6ed2cd160d6851f5565d))
* **tests:** compare bash allowlist paths via realpathSync.native ([42f6a56](https://github.com/BluerAngala/obsidian-aiwork/commit/42f6a5642696df30c92d8e55ac6f6c6cc151a6a0))
* **tests:** make platform-security tests pass on Windows ([5d6a490](https://github.com/BluerAngala/obsidian-aiwork/commit/5d6a490c85d894b739da0699fd720050f0e1cb4e))
* **tests:** mock Obsidian Scope in inline edit diff review tests ([9ab8ea5](https://github.com/BluerAngala/obsidian-aiwork/commit/9ab8ea5bbc57f1bc153e062e81bcfc5a3c04dd9f))
* **toolbar:** list registered editor commands ([78f2753](https://github.com/BluerAngala/obsidian-aiwork/commit/78f275360b63755d366f4afbac1361af8c87f718))
* **toolbar:** reveal Pivi for sidebar commands ([c1507bc](https://github.com/BluerAngala/obsidian-aiwork/commit/c1507bc198cde718b3bc61fa986caa53936248f8))
* **toolbar:** use theme colors for selectors ([d3a2043](https://github.com/BluerAngala/obsidian-aiwork/commit/d3a204396ab06d2972eccd889ceae0d4b9a1f9cf))
* **tools:** apply always-allowed bash entries immediately via session grants ([f9a564b](https://github.com/BluerAngala/obsidian-aiwork/commit/f9a564b4cfb538d1e55fff096c1d767e1b0a6004))
* **tools:** enforce minimum read budget ([c0631b1](https://github.com/BluerAngala/obsidian-aiwork/commit/c0631b158efc9721343b89fb167f5d85b8c9dd3b))
* **tools:** harden Bash and paginated reads ([388e997](https://github.com/BluerAngala/obsidian-aiwork/commit/388e997631863b2cf9160dfbad4e94fb4be6ba7a))
* **tools:** harden Bash grants, command transactions, and tool ownership ([f014ca7](https://github.com/BluerAngala/obsidian-aiwork/commit/f014ca7260524ddd5cef12ff508b15111a3ff1fd))
* **tools:** settle per-turn read budget against actually returned characters ([e830071](https://github.com/BluerAngala/obsidian-aiwork/commit/e830071296ea398bbcb36cd4b7e831c3de972503))
* **ui:** close review gaps in overlay focus, tooltip, and confirmation lifecycle ([15c802a](https://github.com/BluerAngala/obsidian-aiwork/commit/15c802aef9b4795e6cc6f834032d013b27244876))
* **ui:** label OpenCode Go correctly ([f44393f](https://github.com/BluerAngala/obsidian-aiwork/commit/f44393fd1c4dae981f273cebb9fbe552061caa95))
* **ui:** make Pivi icon inherit theme color ([5b7e94c](https://github.com/BluerAngala/obsidian-aiwork/commit/5b7e94c997117b1a02a5e322962d93dfb397bf3e))
* **ui:** rank exact path and folder path-prefix matches higher in @ mentions ([ee8579e](https://github.com/BluerAngala/obsidian-aiwork/commit/ee8579eb2b34af1e70c0eaff9926426607ef3a7c))
* **ui:** register select event listeners on itemEl only during creation in TabBar ([0056d5e](https://github.com/BluerAngala/obsidian-aiwork/commit/0056d5e427f599e3bc54afb27e6b4fc83b2421ea))
* **ui:** restore compact icon sizing and drop oversized hit boxes ([5091064](https://github.com/BluerAngala/obsidian-aiwork/commit/5091064946b13c978c7f1748cf162e5354ce091c))
* **ui:** speed up and align composer selectors ([15314bf](https://github.com/BluerAngala/obsidian-aiwork/commit/15314bfd206605de941a8d5482644b3292627024))
* **ui:** sync Pivi icon across surfaces ([f5c57f4](https://github.com/BluerAngala/obsidian-aiwork/commit/f5c57f41a517c3d06e41fcb6da05990ba24725ce))
* **usage:** CJK-safe read char budget and compaction-aligned meter ([af835b7](https://github.com/BluerAngala/obsidian-aiwork/commit/af835b7c83c72c50704852112eec9d517581adc6))
* **usage:** separate totals from compaction pressure ([c1c128b](https://github.com/BluerAngala/obsidian-aiwork/commit/c1c128bee0263fc676eabbb8b6a1de94334601cb))
* **welcome:** prevent replacement quote overlap ([d900e48](https://github.com/BluerAngala/obsidian-aiwork/commit/d900e48191185399ef6ef25e086517ae843e199b))


### Performance Improvements

* **build:** compress embedded skills cli ([879750a](https://github.com/BluerAngala/obsidian-aiwork/commit/879750ad9f778fb77d106666ade053b2c5d564e8))
* **chat:** isolate projection agent runs ([619c077](https://github.com/BluerAngala/obsidian-aiwork/commit/619c077db2c136efd3b9aef6183e95d38b95f841))
* **chat:** narrow projection row subscriptions ([97615b3](https://github.com/BluerAngala/obsidian-aiwork/commit/97615b357a27f0b2dea15a8e3d3201d8c2c53cec))
* **chat:** reconcile projection entities ([2b03c7a](https://github.com/BluerAngala/obsidian-aiwork/commit/2b03c7a6157060a4dea259714057d64eb50bd450))
* **chat:** subscribe to projection blocks ([f4ddb40](https://github.com/BluerAngala/obsidian-aiwork/commit/f4ddb404a6599d3b1d9dc5fa8a7771c16fccc9b5))
* **chat:** subscribe to projection tools ([edb8628](https://github.com/BluerAngala/obsidian-aiwork/commit/edb86286b6bc55f98dcc52dee5ba34f2cb30b801))
* **chat:** throttle hidden projections ([d9a42f2](https://github.com/BluerAngala/obsidian-aiwork/commit/d9a42f2ffae4f43c1b4b493569c9b1cf46629eab))
* **chat:** virtualize transcripts and optimize streaming ([638b2be](https://github.com/BluerAngala/obsidian-aiwork/commit/638b2be5f764268f6875020d3b1b66fcf7e46182))
* **session:** add isolated indexed paging benchmark ([b730b7f](https://github.com/BluerAngala/obsidian-aiwork/commit/b730b7f34c1ff386955479025347d0774b0897bd))
* **session:** preserve JSONL bytes on append ([fd6d8af](https://github.com/BluerAngala/obsidian-aiwork/commit/fd6d8afe898e2e476257e4b952cf40fcf746dc14))
* **typecheck:** use TypeScript 7 for faster checks ([805af27](https://github.com/BluerAngala/obsidian-aiwork/commit/805af271ba950e9bb75b640083338c4f5571ab23))


### Reverts

* **security:** remove turn-scoped high-risk confirms and Skills/MCP bounds ([b924dcf](https://github.com/BluerAngala/obsidian-aiwork/commit/b924dcffa5c62d4cfc98c9be5b3800520417f245))
