...
- `src/secrets/` re-exports the canonical provider secret-storage surface (the implementation lives in `@pivi/pivi-agent-core/auth/providerSecretStorage`).
